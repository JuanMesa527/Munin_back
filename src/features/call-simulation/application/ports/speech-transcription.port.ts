/**
 * Puerto de transcripcion de voz del closer. Capa: application (puerto LOCAL de F5).
 *
 * Existe por la adenda A12: la Web Speech API del navegador no es un motor
 * local sino un mando a distancia al servicio del fabricante, y solo Chrome
 * presta el suyo de forma fiable. Para que el dictado sirva en cualquier
 * navegador, el reconocimiento tiene que ser nuestro.
 *
 ...
 * escribe. El input de texto es el camino garantizado (spec
 * call-simulation-overlay, "Microphone Failure Never Blocks the Call").
 */
